...
namespace Web.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    ...
                    // translate to bulgarian: Моля потвърдете акаунта си, като <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>кликнете тук</a>. 
                    $"Моля потвърдете акаунта си, като <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>кликнете тук</a>.");

                StatusMessage = "Потвърдителен линк за смяна на имейла е изпратен. Моля проверете имейла си.";
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            StatusMessage = "Потвърдителен линк за имейл е изпратен. Моля проверете имейла си.";
            return RedirectToPage();
        }
    }
}
